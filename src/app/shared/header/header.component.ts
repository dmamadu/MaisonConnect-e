...
export class HeaderComponent {
  ...
  // NOUVEL ORDRE : Menu items sans sous-menu
  menuItems: MenuItem[] = [
    { labelKey: 'nav.accueil', link: '/' },
    { labelKey: 'nav.a-propos', link: '/about' }
  ];

  // NOUVEL ORDRE : Menus avec sous-menus (dans l'ordre requis)
  menuWithSubmenu: MenuItem[] = [
  ...
  // NOUVEL ORDRE : Menus après les sous-menus
